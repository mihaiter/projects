  ...
  /*
    ...
    //  client.println("hello from ESP8266");
      ...
      Serial.println(message);
        ...
        if((message.equalsIgnoreCase("close"))) {ok=false;client.stop();}
    ...
    Serial.print("printing message "+mesaj);
    Serial.println("client available  ?= ");
    Serial.println(client.available());
    Serial.println("is client connected");
    Serial.println(client.connected());
    client.print("alabalaala");
    ...
    //  Serial.println(ServerDrv::availData(client.getFirstSocket()));
    while (client.available()) {
      char ch = static_cast<char>(client.read());
     mesaj+=ch;
